...
import {editBrand} from '../../lib/brands'
...
if (data.categories && data.categories.length){
    ...
    function getdata(){
        ...
        if(data.brands && data.brands.length){
            ...
            const NumOfCategories = data.brands.length;
        ...
        searchQuery = data.brands.filter(category=>
    ...
    //     }
        ...
        if(getdata().length>0){
            ...
            <p>{success?"Brand was edited successfully":""}</p>
            <p>{save?"":"There was an error in editing brand"}</p>
      ...
      <tbody>
          {
            ...
            <span className="error" >{errors.name && errors.name}</span>
                            ...
                            <td>
                            {
                                    ...
                                    (
                                        <React.Fragment>
                                                <MultiSelect
                                        options = {loadarray(thedata)}
                                        onChange = {setCategory}
                                        labelledBy={"Select a category"}
                                        value={categorySel}
                                    
                                    />
                                    <span className="error">{errors.categorySel && 
                                    
                                    (Object.entries(categorySel).length===0) && 
                                    errors.categorySel} </span> 
                                        </React.Fragment>
            ...
            <td><Button   onClick={(e)=>setEdit({...edit,id:brand.id,name:brand.name})}>Edit</Button></td>
                </React.Fragment>
                )
                }
